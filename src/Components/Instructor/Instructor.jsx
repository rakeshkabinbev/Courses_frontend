    ...
    <div className="instructor  bg-[#E2FFF1]" id="Instructor">
      <div className="instructor-container">
        ...
        <div className="instructor-content space-y-2">
          ...
          <p>
            Anil Sharma is experienced Web Developer He is one of the best
            educator who has helped multiples students to get placement in
            multiple companies.
          </p>
      ...
      <p className="text-[14px]">
        Anil has further experience in many fields and he has working experience
        of 10+ year and himself worked on many professional projects .
      </p>
