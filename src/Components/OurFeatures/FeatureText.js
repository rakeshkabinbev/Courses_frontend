...
const FeatureTexts = [
  <>
    <p className="text-[34px] text-[#000000] font-pop font-semibold xsm:text-[8px]">
      A{" "}
    ...
    <div className="flex flex-col gap-4 mt-2 xsm:gap-2 xsm:mt-0">
      <div className="flex flex-row gap-10 justify-between items-center xsm:gap-2">
        ...
        <p className="text-[#696984] text-[20px] font-pop xsm:text-[6px]">
  ...
  <>
    <p className="text-[34px] text-[#000000] font-pop font-semibold xsm:text-[10px]">
      <span style={{ color: "#33EFA0", fontWeight: "bold" }}>Tools</span> For
      Teachers And Learners
    </p>
    <div className="flex flex-col gap-4">
      <p className="text-[#696984] text-[20px] font-pop leading-8 xsm:text-[6px] xsm:leading-3">
